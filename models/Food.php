...
class Food extends Product {
    ...
    function __construct(String $name,String $description,Float $price, String $image, Bool $inStock, Category $category, Int $quantity, Int $shelfNo, String $laneNo, Int $calories, Int $fats, ){
